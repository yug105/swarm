...
#include "px4_msgs_old/msg/detail/vehicle_status_v0__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs_old::msg::VehicleStatusV0;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const px4_msgs_old::msg::VehicleStatusV0 *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<px4_msgs_old::msg::VehicleStatusV0 *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VehicleStatusV0__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const px4_msgs_old::msg::VehicleStatusV0 *>(
...
static size_t _VehicleStatusV0__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VehicleStatusV0(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VehicleStatusV0__callbacks = {
  "px4_msgs::msg",
  "VehicleStatus",
...
static rosidl_message_type_support_t _VehicleStatusV0__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VehicleStatusV0__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_px4_msgs_old
const rosidl_message_type_support_t *
get_message_type_support_handle<px4_msgs_old::msg::VehicleStatusV0>()
{
  return &px4_msgs_old::msg::typesupport_fastrtps_cpp::_VehicleStatusV0__handle;
}
