...
#include "px4_msgs_old/msg/detail/vehicle_status_v0__rosidl_typesupport_fastrtps_c.h"
...
#include "px4_msgs_old/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _VehicleStatusV0__ros_msg_type = px4_msgs_old__msg__VehicleStatusV0;

static bool _VehicleStatusV0__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VehicleStatusV0__ros_msg_type * ros_message = static_cast<const _VehicleStatusV0__ros_msg_type *>(untyped_ros_message);
...
static bool _VehicleStatusV0__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _VehicleStatusV0__ros_msg_type * ros_message = static_cast<_VehicleStatusV0__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    cdr >> ros_message->timestamp;
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs_old
size_t get_serialized_size_px4_msgs_old__msg__VehicleStatusV0(
  const void * untyped_ros_message,
...
static uint32_t _VehicleStatusV0__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_px4_msgs_old__msg__VehicleStatusV0(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_px4_msgs_old
size_t max_serialized_size_px4_msgs_old__msg__VehicleStatusV0(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = px4_msgs_old__msg__VehicleStatusV0;
    is_plain =
      (
...
static size_t _VehicleStatusV0__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_px4_msgs_old__msg__VehicleStatusV0(
...
static message_type_support_callbacks_t __callbacks_VehicleStatusV0 = {
  "px4_msgs::msg",
  "VehicleStatus",
  _VehicleStatusV0__cdr_serialize,
  _VehicleStatusV0__cdr_deserialize,
  _VehicleStatusV0__get_serialized_size,
  _VehicleStatusV0__max_serialized_size
};

static rosidl_message_type_support_t _VehicleStatusV0__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VehicleStatusV0,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, px4_msgs_old, msg, VehicleStatusV0)() {
  return &_VehicleStatusV0__type_support;
}
