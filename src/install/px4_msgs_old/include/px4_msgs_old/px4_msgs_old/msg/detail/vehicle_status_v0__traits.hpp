...
#ifndef PX4_MSGS_OLD__MSG__DETAIL__VEHICLE_STATUS_V0__TRAITS_HPP_
#define PX4_MSGS_OLD__MSG__DETAIL__VEHICLE_STATUS_V0__TRAITS_HPP_
...
inline std::string to_yaml(const VehicleStatusV0 & msg, bool use_flow_style = false)
{
...
[[deprecated("use px4_msgs_old::msg::to_block_style_yaml() instead")]]
inline void to_yaml(
  const px4_msgs_old::msg::VehicleStatusV0 & msg,
  std::ostream & out, size_t indentation = 0)
{
  px4_msgs_old::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use px4_msgs_old::msg::to_yaml() instead")]]
inline std::string to_yaml(const px4_msgs_old::msg::VehicleStatusV0 & msg)
{
  return px4_msgs_old::msg::to_yaml(msg);
}

template<>
inline const char * data_type<px4_msgs_old::msg::VehicleStatusV0>()
{
  return "px4_msgs_old::msg::VehicleStatusV0";
}

template<>
inline const char * name<px4_msgs_old::msg::VehicleStatusV0>()
{
  return "px4_msgs_old/msg/VehicleStatusV0";
}

template<>
struct has_fixed_size<px4_msgs_old::msg::VehicleStatusV0>
  : std::integral_constant<bool, true> {};

template<>
struct has_bounded_size<px4_msgs_old::msg::VehicleStatusV0>
  : std::integral_constant<bool, true> {};

template<>
struct is_message<px4_msgs_old::msg::VehicleStatusV0>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // PX4_MSGS_OLD__MSG__DETAIL__VEHICLE_STATUS_V0__TRAITS_HPP_
