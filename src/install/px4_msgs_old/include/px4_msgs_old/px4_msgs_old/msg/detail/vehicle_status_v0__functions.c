...
bool
px4_msgs_old__msg__VehicleStatusV0__init(px4_msgs_old__msg__VehicleStatusV0 * msg)
{
  if (!msg) {
    return false;
  }
...
void
px4_msgs_old__msg__VehicleStatusV0__fini(px4_msgs_old__msg__VehicleStatusV0 * msg)
{
  if (!msg) {
    return;
  }
...
bool
px4_msgs_old__msg__VehicleStatusV0__are_equal(const px4_msgs_old__msg__VehicleStatusV0 * lhs, const px4_msgs_old__msg__VehicleStatusV0 * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
px4_msgs_old__msg__VehicleStatusV0__copy(
  const px4_msgs_old__msg__VehicleStatusV0 * input,
  px4_msgs_old__msg__VehicleStatusV0 * output)
{
  if (!input || !output) {
    return false;
  }
...
px4_msgs_old__msg__VehicleStatusV0__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs_old__msg__VehicleStatusV0 * msg = (px4_msgs_old__msg__VehicleStatusV0 *)allocator.allocate(sizeof(px4_msgs_old__msg__VehicleStatusV0), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(px4_msgs_old__msg__VehicleStatusV0));
  bool success = px4_msgs_old__msg__VehicleStatusV0__init(msg);
  if (!success) {
...
void
px4_msgs_old__msg__VehicleStatusV0__destroy(px4_msgs_old__msg__VehicleStatusV0 * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    px4_msgs_old__msg__VehicleStatusV0__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
bool
px4_msgs_old__msg__VehicleStatusV0__Sequence__init(px4_msgs_old__msg__VehicleStatusV0__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs_old__msg__VehicleStatusV0 * data = NULL;

  if (size) {
    data = (px4_msgs_old__msg__VehicleStatusV0 *)allocator.zero_allocate(size, sizeof(px4_msgs_old__msg__VehicleStatusV0), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = px4_msgs_old__msg__VehicleStatusV0__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        px4_msgs_old__msg__VehicleStatusV0__fini(&data[i - 1]);
      }
...
void
px4_msgs_old__msg__VehicleStatusV0__Sequence__fini(px4_msgs_old__msg__VehicleStatusV0__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      px4_msgs_old__msg__VehicleStatusV0__fini(&array->data[i]);
    }
...
px4_msgs_old__msg__VehicleStatusV0__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  px4_msgs_old__msg__VehicleStatusV0__Sequence * array = (px4_msgs_old__msg__VehicleStatusV0__Sequence *)allocator.allocate(sizeof(px4_msgs_old__msg__VehicleStatusV0__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = px4_msgs_old__msg__VehicleStatusV0__Sequence__init(array, size);
  if (!success) {
...
void
px4_msgs_old__msg__VehicleStatusV0__Sequence__destroy(px4_msgs_old__msg__VehicleStatusV0__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    px4_msgs_old__msg__VehicleStatusV0__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
px4_msgs_old__msg__VehicleStatusV0__Sequence__are_equal(const px4_msgs_old__msg__VehicleStatusV0__Sequence * lhs, const px4_msgs_old__msg__VehicleStatusV0__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!px4_msgs_old__msg__VehicleStatusV0__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
px4_msgs_old__msg__VehicleStatusV0__Sequence__copy(
  const px4_msgs_old__msg__VehicleStatusV0__Sequence * input,
  px4_msgs_old__msg__VehicleStatusV0__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(px4_msgs_old__msg__VehicleStatusV0);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    px4_msgs_old__msg__VehicleStatusV0 * data =
      (px4_msgs_old__msg__VehicleStatusV0 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!px4_msgs_old__msg__VehicleStatusV0__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          px4_msgs_old__msg__VehicleStatusV0__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!px4_msgs_old__msg__VehicleStatusV0__copy(
