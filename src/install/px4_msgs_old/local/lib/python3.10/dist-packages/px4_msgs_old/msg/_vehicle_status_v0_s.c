...
bool px4_msgs_old__msg__vehicle_status_v0__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4_msgs_old.msg._vehicle_status_v0.VehicleStatusV0", full_classname_dest, 51) == 0);
  }
  px4_msgs_old__msg__VehicleStatusV0 * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of VehicleStatusV0 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4_msgs_old.msg._vehicle_status_v0");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleStatusV0");
